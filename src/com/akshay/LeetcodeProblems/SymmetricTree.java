...
public class SymmetricTree {
    // o check if a binary tree is symmetric, we need to compare its left subtree and right subtree.
    ...
    // Otherwise, we can immediately return false.
    ...
    // The helper function returns true if both nodes are null,
